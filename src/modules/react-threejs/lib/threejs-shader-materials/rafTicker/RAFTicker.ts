...
export class RAFTicker {
  ...
  private static _lastUpdateTimestamp: number | undefined;
  protected static _id: number | undefined;
  ...
  public static start() {
    if (!RAFTicker._id) {
      ...
      // Only start ticking if running in a browser environment
  ...
  public static stop() {
    if (typeof window !== "undefined" && typeof cancelAnimationFrame === "function") {
      if (RAFTicker._id !== undefined) {
