class InfoBoxControl {
    constructor(options = InfoBoxControl.DEFAULT_OPTIONS) {
        this.createContainer(options);
        const controlOptions = Object.assign({}, InfoBoxControl.DEFAULT_OPTIONS, options);
...
exports.InfoBoxControl = InfoBoxControl;
InfoBoxControl.DEFAULT_OPTIONS = {
    layerId: "features",
    formatter: properties => properties ? `Name: ${properties['name']}` : ''
};
class GradientBoxControl {
    constructor(options = GradientBoxControl.DEFAULT_OPTIONS) {
        const controlOptions = Object.assign({}, GradientBoxControl.DEFAULT_OPTIONS, options);
...
exports.GradientBoxControl = GradientBoxControl;
GradientBoxControl.DEFAULT_OPTIONS = {
