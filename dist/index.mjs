...
var _EffectCanvas = (props, ref) => {
  ...
  return effectManager && /* @__PURE__ */ jsx5(EffectCanvasContext.Provider, { value: contextValue, children });
};
...
var _LineMesh = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx6(MeshContext.Provider, { value: { mesh }, children });
};
...
var _WallMesh = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx7(MeshContext2.Provider, { value: { mesh }, children });
};
